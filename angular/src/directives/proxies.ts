...
@Component({ selector: 'ion-drawer', changeDetection: ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['cssClass', 'maxOffset', 'mode', 'openHeightEnd', 'openHeightMiddle', 'openHeightStart', 'openTo'] })
...
proxyInputs(IonDrawer, ['cssClass', 'maxOffset', 'mode', 'openHeightEnd', 'openHeightMiddle', 'openHeightStart', 'openTo']);
